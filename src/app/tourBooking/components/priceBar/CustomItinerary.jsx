                        ...
                        <div className={styles.popupContent}>
                                ...
                                <div className={styles.TravelPreferences}>
                                    ...
                                    <div className={styles.TravelPreferencesCenter}>
                                        ...
                                        <div className={styles.calenderTabContainer}>
                                            <div className={styles.calenderTab}>
                            ...
                            {currentStep === 2 && (
                                <div className={styles.customization}>
                                    <h3 className={styles.customHeading}>Customize Your Experience</h3>
                                    <p className={styles.customSub}>Tailor your journey to match your preferences</p>

                                    <div className={styles.section}>
                                        <h4 className={styles.sectionTitle}>HOTEL CATEGORY</h4>
                                        <div className={styles.hotelCategory}>
                                            {['Standard','Premium','Luxury'].map((c)=> (
                                                <button key={c} className={`${styles.categoryOption} ${hotelCategory===c?styles.activeCategory:''}`} onClick={()=>setHotelCategory(c)}>{c}</button>
                                            ))}
                                        </div>
                                    </div>

                                    <div className={styles.section}>
                                        <h4 className={styles.sectionTitle}>EXPERIENCE ADD-ONS</h4>
                                    ...
                                    <div className={styles.section}>
                                        <h4 className={styles.sectionTitle}>BUDGET FOR ADD-ONS</h4>
                                        <div className={styles.rangeRow}>
                                            <div className={styles.rangeWrap}>
                                                <input className={styles.range} type="range" min={0} max={100000} step={1000} value={minPrice} onChange={handleMinChange} />
                                                <input className={styles.range} type="range" min={0} max={100000} step={1000} value={maxPrice} onChange={handleMaxChange} />
                                            </div>
                                            <div className={styles.rangeLabels}>
                                                <div>₹{minPrice.toLocaleString()}</div>
                                                <div>Up ₹{maxPrice.toLocaleString()}+</div>
                                            </div>
                                        </div>
                                    </div>

                                    <div className={styles.section}>
                                        <h4 className={styles.sectionTitle}>SPECIAL REQUESTS OR NOTES</h4>
                            ...
                            <div className={styles.TravelPreferencesButtonContainer}>
                                ...
                                <button className={styles.TravelPreferencesNextButton} onClick={handleNext}>{currentStep === 2 ? 'CONFIRM' : 'CONTINUE'}</button>
                            </div>
