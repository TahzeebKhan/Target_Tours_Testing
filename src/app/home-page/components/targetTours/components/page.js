...
//                   <div
//                     className={`${styles["hover-card"]} ${idx == 0 ? styles.leftCard : ""
//                       } ${idx == 1 ? styles.midCard : ""} ${idx == 2 ? styles.rightCard : ""
//                       }`}
//                     key={card.id}
//                   >
//                     <img
//                       className={`${idx == 0 ? styles.leftImg : ""} ${idx == 1 ? styles.midImg : ""
//                         } ${idx == 2 ? styles.rightImg : ""} ${card.centerImage ? styles.centerImg : ""
//                         }`}
//                       src={card.img}
//                       alt={card.title}
//                     />
