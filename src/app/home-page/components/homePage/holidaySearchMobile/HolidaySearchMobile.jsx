...
const HolidaySearchMobile = ({
    ...
    return (
        <div className={styles.flightSectionMain}>
            <button type="button" className={`${styles.swapBtn} ${styles.HolidaySwapBtn}`}>
            ...
            <div className={styles.flightSearchCard}>
                <div className={styles.fromToCont}>
                    ...
                    {openFrom && (
                        <FromLocationSheet onClose={() => setOpenFrom(false)} inputType="From CITY" onSelectCity={(value) => setFrom(value)} />
                    )}
                    ...
                    {openTo && (
                        <FromLocationSheet onClose={() => setOpenTo(false)} inputType="To CITY/COUNTRY,CATEGORY" onSelectCity={(value) => setTo(value)} />
                    )}
                </div>
