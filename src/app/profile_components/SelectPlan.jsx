...
const SelectPlan = ({ setCurrentStep }) => {
        ...
        <div className={styles.container}>
          ...
          <div className={styles.coverageTabs}>
            {coverageOptions.map((amount, index) => (
              <button
                key={index}
                className={`${styles.coverageBtn} ${selectedCoverage === index ? styles.activeTab : ""
                  }`}
          ...
          <section className={styles.plansGrid}>
            {plans.map((plan) => (
              <div
                key={plan.id}
                className={`${styles.planCard} ${selectedPlan === plan.id ? styles.selectedPlanCard : ""
                  }`}
              ...
              >
                <div className={styles.planHeader}>
                  ...
                  <div
                    className={`${styles.radioCircle} ${selectedPlan === plan.id ? styles.radioActive : ""
                      }`}
                  />
                </div>
