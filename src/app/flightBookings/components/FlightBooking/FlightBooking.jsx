            ...
            <div className={styles.expendableContainer}>
                ...
                <div key={flight.id} className={styles.flightFareDetailsContainer}>
                    <div className={styles.flightFareDetails}>
                        ...
                        <div className={styles.seeDetailsBtn} onClick={() => setOpen(prev => !prev)}>
                            See Details
                            <svg className={`${styles.downArrow} ${open ? styles.rotate : ''}`} width="8" height="5" viewBox="0 0 8 5" fill="none" xmlns="http://www.w3.org/2000/svg">
