        ...
        <header className={styles.header}>
          ...
          <div className={styles.addressSection}>
            <div className={styles.addressBlock}>
              ...
              <p className={styles.value}>Single Trip</p>
            </div>
            ...
            <div className={styles.addressBlock}>
              ...
              <div className={styles.baggage}>
                <p className={styles.value}>International Trip</p>
          ...
          <div className={styles.bookingMeta}>
            <div className={styles.metaBox}>
              <span className={styles.metaLabel}>Policy Start</span>
            ...
            <div className={styles.metaBox}>
              <span className={styles.metaLabel}>Policy End</span>
              <div className={styles.dateBlock}>
          ...
          <div className={styles.statsRow}>
            <div className={styles.statItem}>
              ...
              <span className={styles.statValue}>8 Days</span>
            </div>
